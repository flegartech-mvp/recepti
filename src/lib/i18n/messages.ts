export const slMessages: Record<string, string> = {
  ...
  "Owner diagnostics": "Diagnostika lastnika",
  "A safe owner-only check of authentication, database, RLS, migrations, and private storage configuration.":
    "Varen pregled nastavitev prijave, podatkovne zbirke, RLS, migracij in zasebne shrambe, namenjen samo lastniku.",
  "{count} checks need attention": "{count} preverjanj zahteva pozornost",
  "All owner checks passed": "Vsa preverjanja lastnika so uspešna",
  "No secret values, tokens, private rows, or storage object names are shown on this page.":
    "Na tej strani niso prikazane skrivne vrednosti, žetoni, zasebne vrstice ali imena datotek v shrambi.",
  Pass: "Uspešno",
  Fail: "Napaka",
  "Configuration is ready.": "Nastavitev je pripravljena.",
  "Authenticated user ID is available":
    "ID prijavljenega uporabnika je na voljo",
  "Google provider is permitted": "Ponudnik Google je dovoljen",
  "Server owner configuration is present":
    "Strežniška nastavitev lastnika je prisotna",
  "Authenticated email matches owner configuration":
    "E-pošta prijavljenega uporabnika se ujema z nastavitvijo lastnika",
  "PostgreSQL owner allowlist recognizes this owner":
    "Seznam dovoljenih lastnikov PostgreSQL prepozna tega lastnika",
  "Required database tables exist": "Zahtevane tabele obstajajo",
  "Required RPC functions exist": "Zahtevane funkcije RPC obstajajo",
  "Required migrations are applied": "Zahtevane migracije so izvedene",
  "RLS is active on protected tables": "RLS je aktiven na zaščitenih tabelah",
  "Private recipe image bucket is configured":
    "Zasebna shramba slik receptov je nastavljena",
  "Owner can read the private storage namespace":
    "Lastnik lahko bere svoj zasebni prostor v shrambi",
  "Application and database owner configuration agree":
    "Nastavitvi lastnika v aplikaciji in podatkovni zbirki se ujemata",
  ...
  "Find catalogue options for {name}": "Poišči možnosti v katalogih za {name}",
  ...
  "Choose which retailer catalogues are used for product and package matching.":
    "Izberite kataloge trgovcev za ujemanje izdelkov in pakiranj.",
  "Live prices are not available": "Cene v živo niso na voljo",
  "The catalogue supports retailer, brand, ingredient, and package matching only. Cheapest-basket, loyalty-price, and promotion optimization stay disabled until maintained price data is available.":
    "Katalog podpira le ujemanje trgovcev, blagovnih znamk, sestavin in pakiranj. Optimizacija najcenejše košarice, cen zvestobe in akcij ostaja izklopljena, dokler niso na voljo vzdrževani podatki o cenah.",
